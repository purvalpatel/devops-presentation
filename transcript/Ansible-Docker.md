...
5.What is playbook.
	...
	c)Managing Tasks using tags and variables:
		i.Tag
			1.If the playbook is too big, if wanted to run specific part.for example, i have one playbook which contains install and start service part. Now i wanted to start service only. 
		ii.Variables
			1.Static
